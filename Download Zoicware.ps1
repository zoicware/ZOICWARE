...
switch ($msgBoxInput) {
    ...
    'Yes' {
        ...
        try {
            Invoke-RestMethod -Uri "https://github.com/abbodi1406/vcredist/releases/download/$version/VisualCppRedist_AIO_x86_x64.exe" -UseBasicParsing -OutFile "$env:TEMP\VisualCppRedist_AIO_x86_x64.exe" -ErrorAction Stop

        }
        catch {
            Write-Host 'Error Accessing Cpp Download Link...Trying again.'
        ...
        try {
            ...
            Write-host 'Error Accessing DX Download Link...Trying again.'
