...
$form.Size = New-Object System.Drawing.Size(675, 280)
...
#seperate options with line 


$lineStartPoint = New-Object System.Drawing.Point(170, 15)
$lineEndPoint = New-Object System.Drawing.Point(170, 135)
...
$lineEndPoint2 = New-Object System.Drawing.Point(395, 135)
...
$checkbox12.Text = 'Enable Taskbar Bell Icon'
...
#$OKButton.Location = New-Object System.Drawing.Point(230, 200)
...
#$CancelButton.Location = New-Object System.Drawing.Point(325, 200)
...
'@; $V = ''; 'id', 'key' | ForEach-Object { $V += "`n`$$_='$($(Get-Variable $_ -val)-replace"'","''")';" }; Set-ItemProperty $key $id $V, $code -type 7 -force -ea 0
  ...
  if ($checkbox4.Checked) {
    ...
    if (!(Get-AppxPackage 'Microsoft.WindowsStore')) {
      ...
      $store = Search-File '*Microsoft.WindowsStore.AppxBundle'
      $dependency = Search-File '*Microsoft.UI.Xaml.2.4.Appx'
      Add-AppPackage -Path $store -DependencyPath $dependency 
    }
...
'
  ...
  if ($checkbox6.Checked) {
    ...
    Invoke-WebRequest -Uri 'https://aka.ms/GamingRepairTool' -UseBasicParsing -OutFile "$env:TEMP\GamingRepairTool.exe"
    Start-Process "$env:TEMP\GamingRepairTool.exe" -Wait -WindowStyle Normal
    Remove-Item "$env:TEMP\GamingRepairTool.exe" -Force -ErrorAction SilentlyContinue
  }


  if ($checkbox7.Checked) {
    Write-Status -Message 'Disabling Qos for Upload and Resetting Network Changes...' -Output
...
'@
  ...
  if ($checkbox12.Checked) {
    Write-Status -Message 'Showing Bell Icon on Taskbar...' -Type Output
    Reg.exe delete 'HKCU\Software\Policies\Microsoft\Windows\Explorer' /v 'DisableNotificationCenter' /f *>$null
    Reg.exe delete 'HKLM\SOFTWARE\Policies\Microsoft\Windows\Explorer' /v 'DisableNotificationCenter' /f *>$null
  }
