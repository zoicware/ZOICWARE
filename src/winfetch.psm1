...
'@
    ...
    $img = if (-not $noimage) {
        ...
        elseif (($CustomAscii -is [Array]) -and ($CustomAscii.Length -gt 0)) {
            ...
            if ($logo -eq "Windows 11") {
                $COLUMNS = 32
                @(
                    "${e}[${t};34;40mlllllllllllllll   lllllllllllllll"
                    "${e}[${t};34;40mlllllllllllllll   lllllllllllllll"
                    "${e}[${t};34;40mlllllllllllllll   lllllllllllllll"
                    "${e}[${t};34;40mlllllllllllllll   lllllllllllllll"
                    "${e}[${t};34;40mlllllllllllllll   lllllllllllllll"
            ...
            elseif ($logo -eq "Windows 10" -Or $logo -eq "Windows 8.1" -Or $logo -eq "Windows 8") {
                ...
                @(
                    "${e}[${t};34;40m                    ....,,:;+ccllll"
                    "${e}[${t};34;40m      ...,,+:;  cllllllllllllllllll"
                    "${e}[${t};34;40m,cclllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    ...
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40mllllllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40m``'ccllllllllll  lllllllllllllllllll"
                    "${e}[${t};34;40m      ``' \\*::  :ccllllllllllllllll"
                    "${e}[${t};34;40m                       ````````''*::cll"
                    "${e}[${t};34;40m                                 ````"
                )
            }
            elseif ($logo -eq "Windows 7" -Or $logo -eq "Windows Vista" -Or $logo -eq "Windows XP") {
                ...
                @(
                    ...
                    "${e}[${t};34;40m    ,.=::::it=., ${e}[31m`` ${e}[32m@EEEEEEtttz33QF  "
                    "${e}[${t};34;40m   ;::::::::zt33)   ${e}[32m'4EEEtttji3P*   "
                    "${e}[${t};34;40m  :t::::::::tt33 ${e}[33m:Z3z..  ${e}[32m```` ${e}[33m,..g.   "
                    "${e}[${t};34;40m  i::::::::zt33F ${e}[33mAEEEtttt::::ztF    "
                    "${e}[${t};34;40m ;:::::::::t33V ${e}[33m;EEEttttt::::t3     "
                    "${e}[${t};34;40m E::::::::zt33L ${e}[33m@EEEtttt::::z3F     "
                    "${e}[${t};34;40m{3=*^``````'*4E3) ${e}[33m;EEEtttt:::::tZ``     "
                    "${e}[${t};34;40m            `` ${e}[33m:EEEEtttt::::z7       "
                    "${e}[${t};33m                'VEzjt:;;z>*``       "
                )
            }
            ...
            elseif ($logo -eq "Windows 2000" -Or $logo -eq "Windows 98" -Or $logo -eq "Windows 95") {
                ...
                @(
                    ...
                    "${e}[${t};30m::::: ====== 000000 BBBBB${e}[${t};34;40mdBB${e}[${t};30mBBBB${e}[${t};33mBBBb${e}[${t};30mBBBBB${e}[${t};30mBBBB"
                    "${e}[${t};34;40m::::: ${e}[${t};30m====== 000${e}[${t};34;40m000 BBBBBBBB${e}[${t};30mBBBB${e}[${t};33mBBBBBBBBB${e}[${t};30mBBBB"
                    "${e}[${t};34;40m::::: ====== 000000 BBBBBBBB${e}[${t};30mBBBB${e}[${t};33mBBBBBBBBB${e}[${t};30mBBBB"
                    "${e}[${t};34;40m::::: ====== 000000 BBBBBBBB${e}[${t};30mBBBB${e}[${t};33mBBBBBBBBB${e}[${t};30mBBBB"
                    "${e}[${t};34;40m::::: ====== 000000 BBBBBBBB${e}[${t};30mBBBB${e}[${t};33mBBBBBBBBB${e}[${t};30mBBBB"
                    "${e}[${t};34;40m::::: ====== 000000 BBBBf${e}[${t};30mBBBBBBBBBBB${e}[${t};33m`BBBB${e}[${t};30mBBBB"
                    "${e}[${t};30m::::: ${e}[${t};34;40m====== 000${e}[${t};30m000 BBBBBf         `BBBBBBBBB"
    ...
    function info_title {
        return @{
            title   = ""
            content = "${e}[1;36;40m{0}${e}[37;40m@${e}[1;36;40m{1}${e}[0m" -f [System.Environment]::UserName, $env:COMPUTERNAME
        }
    }
	...
	Write-Host "$([char]27)[40m " -NoNewline
    }
    ...
    foreach ($item in $config) {
        ...
        foreach ($line in $info) {
            $output = "$e[1;36;40m$($line["title"])$e[0m"

            if ($line["title"] -and $line["content"]) {
                $output += "$e[37;40m: "
            }

            $output += "$e[37;40m$($line["content"])$e[0m"
