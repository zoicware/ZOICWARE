...
function OptionalTweaks {
  ...
  if ($AutoRun) {
    ...
    $checkbox53.Location = new-object System.Drawing.Size(220, 380)
    ...
    $TabPage1.Controls.Add($checkBox53)
...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $checkbox24.Location = New-Object System.Drawing.Point(20, 190)
    $checkbox24.Size = New-Object System.Drawing.Size(360, 30)
    $checkbox24.Text = 'Disable Notepad Tabs and Rewrite'
    $checkbox24.Font = New-Object System.Drawing.Font($dmMonoFont, 9)
    $checkbox24.ForeColor = 'White'
    $checkbox24.Checked = $false
    $tabMisc.Controls.Add($checkbox24)
