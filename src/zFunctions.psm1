...
function OptionalTweaks {
  ...
  if ($AutoRun) {
    ...
    $checkbox61.Location = New-Object System.Drawing.Size(270, 120)
    ...
    $checkbox62.Location = New-Object System.Drawing.Size(270, 145)
...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $checkbox26.Location = New-Object System.Drawing.Point(20, 220)
    ...
    $checkbox28.Location = New-Object System.Drawing.Point(20, 250)
    ...
    $checkbox29.Location = New-Object System.Drawing.Point(20, 280)
    ...
    $checkbox30.Location = New-Object System.Drawing.Point(20, 310)
    ...
    $checkbox31.Location = New-Object System.Drawing.Point(20, 340)
...
'@
      ...
      Invoke-Expression -Command $disableTilesScript
...
'@
    ...
    if ($checkbox31.Checked) {
      ...
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\734731404' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\2114784909' /v 'EnabledState' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\2114784909' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\905601679' /v 'EnabledState' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\905601679' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\1853569164' /v 'EnabledState' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\1853569164' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
    }
