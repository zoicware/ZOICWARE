...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $infobutton = New-Object Windows.Forms.Button
    $infobutton.Location = New-Object Drawing.Point(5, 380)    
    $infobutton.Size = New-Object Drawing.Size(30, 27)
    $infobutton.Cursor = 'Hand'
    $infobutton.Add_Click({
        try {
    ...
    $contentPanel = New-Object System.Windows.Forms.Panel
    $contentPanel.Location = New-Object System.Drawing.Point(160, 0)
    $contentPanel.Size = New-Object System.Drawing.Size(380, 450)     
    ...
    $patchExplorerPanel.Size = New-Object System.Drawing.Size(380, 450)   
    ...
    $win10Panel.Size = New-Object System.Drawing.Size(380, 450)     
    ...
    $miscPanel.Size = New-Object System.Drawing.Size(380, 450)   
    $miscPanel.Visible = $false
    ...
    $OKButton = Create-ModernButton -Text 'OK' -Location (New-Object Drawing.Point(140, 370)) -Size (New-Object Drawing.Size(100, 27)) -DialogResult ([System.Windows.Forms.DialogResult]::OK) -borderSize 2

    $patchExplorerPanel.controls.add($OKButton)

    $CancelButton = Create-ModernButton -Text 'Cancel' -Location (New-Object Drawing.Point(250, 370)) -Size (New-Object Drawing.Size(100, 27)) -DialogResult ([System.Windows.Forms.DialogResult]::Cancel) -borderSize 2
...
'@
    ...
    if ($checkbox27.Checked) {
      ...
      Reg.exe add 'HKCU\Software\Microsoft\Windows\CurrentVersion\CrossDeviceResume\Configuration' /v 'IsOneDriveResumeAllowed' /t REG_DWORD /d '0' /f
      #disable resume with csp policy 
      Reg.exe add 'HKLM\SOFTWARE\Microsoft\PolicyManager\default\Connectivity\DisableCrossDeviceResume' /v 'value' /t REG_DWORD /d '1' /f
      #disable resume with velocity id
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\8\1387020943' /v 'EnabledState' /t REG_DWORD /d '1' /f
...
function Install-Browsers {
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    if ($chromeRadio.Checked) {
      ...
      Write-Status -Message 'Enabling Ublock Origin Support...' -Type Output
      Write-Status -Message 'Running Chrome Temporarily...' -Type Output
...
'@ -Name 'Win32ShowWindowAsync' -Namespace Win32Functions -PassThru | Out-Null
      ...
      Start-Sleep 1
      $handle = (Get-Process -Name 'chrome' | Where-Object { $_.MainWindowHandle -ne [System.IntPtr]::Zero } | Select-Object -First 1).MainWindowHandle
      [Win32Functions.Win32ShowWindowAsync]::ShowWindowAsync($handle, 6) | Out-Null
      Start-Sleep 1
      ...
      if (($jsonContent.browser | Get-Member -MemberType NoteProperty enabled_labs_experiments) -eq $null) {
        Write-Status -Message 'Adding enabled_labs_experiments Property...' -Type Output
      ...
      $jsonContent.browser.enabled_labs_experiments = @(
        ...
        'temporary-unexpire-flags-m139@1'
      ) 

      $newContent = $jsonContent | ConvertTo-Json -Compress -Depth 10 
      Write-Status -Message 'Adding Chrome Flags to Config...' -Type Output
      ...
      # Write-Status -Message 'Installing Ublock Origin...' -Type Output 
      #seems to not work anymore
      #Reg.exe add 'HKLM\SOFTWARE\Policies\Google\Chrome\ExtensionInstallForcelist' /v '1' /t REG_SZ /d 'cjpalhdlnbpafiamejdnhcphjbkeiagm;https://clients2.google.com/service/update2/crx' /f
