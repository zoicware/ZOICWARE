      ...
      'debloatAll' {
        foreach ($Bloat in $Bloatware) {
          ...
          if ($Bloat -notin $lockedAppxPackages -and !$isProhibited) {
            ...
            if (!($Bloat -like '*NVIDIA*' -or $Bloat -like '*Photos*' -or $Bloat -eq 'Microsoft.Paint' -or $Bloat -like '*Notepad*' -or $Bloat -like '*WindowsTerminal*')) { 
      ...
      'debloatKeepStore' {
        foreach ($Bloat in $Bloatware) {
          ...
          if ($Bloat -notin $lockedAppxPackages -and !$isProhibited) {
            ...
            #dont remove store
            if (!($Bloat -like '*NVIDIA*' -or $Bloat -like '*Photos*' -or $Bloat -eq 'Microsoft.Paint' -or $Bloat -like '*Store*' -or $Bloat -like '*Notepad*' -or $Bloat -like '*WindowsTerminal*')) { 
              Write-Status -Message "Trying to remove $Bloat" -Type Output
              debloatAppx -Bloat $Bloat
            }          
          }
      ...
      'debloatKeepStoreXbox' {
        foreach ($Bloat in $Bloatware) {
          ...
          if ($Bloat -notin $lockedAppxPackages -and !$isProhibited) {
            ...
            if (!($Bloat -like '*NVIDIA*' -or $Bloat -like '*Photos*' -or $Bloat -eq 'Microsoft.Paint' -or $Bloat -like '*Store*' -or $Bloat -like '*Xbox*' -or $Bloat -like '*Gaming*' -or $Bloat -like '*Notepad*' -or $Bloat -like '*WindowsTerminal*')) { 
              Write-Status -Message "Trying to remove $Bloat" -Type Output
              debloatAppx -Bloat $Bloat
            }          
          }
    ...
    function Get-Packages {
      ...
      if ($showLockedPackages) {
        ...
        foreach ($package in $Global:sortedPackages) {
          ...
          if ($package.Name -in $Global:lockedAppxPackages -and -not $isProhibited) {
        ...
        foreach ($package in $Global:sortedPackages) {
          $isProhibited = $Global:prohibitedPackages | Where-Object { $package.Name -like $_ }
          if ($package.Name -notin $Global:lockedAppxPackages -and -not $isProhibited) {
