...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $infobutton = New-Object Windows.Forms.Button
    $infobutton.Location = New-Object Drawing.Point(5, 360)    
    $infobutton.Size = New-Object Drawing.Size(30, 27)
    $infobutton.Cursor = 'Hand'
    $infobutton.Add_Click({
        try {
    ...
    $contentPanel = New-Object System.Windows.Forms.Panel
    $contentPanel.Location = New-Object System.Drawing.Point(160, 0)
    $contentPanel.Size = New-Object System.Drawing.Size(380, 430)     
    ...
    $patchExplorerPanel.Size = New-Object System.Drawing.Size(380, 430)   
    ...
    $win10Panel.Size = New-Object System.Drawing.Size(380, 430)     
    ...
    $miscPanel.Size = New-Object System.Drawing.Size(380, 430)   
    $miscPanel.Visible = $false
    ...
    $OKButton = Create-ModernButton -Text 'OK' -Location (New-Object Drawing.Point(140, 350)) -Size (New-Object Drawing.Size(100, 27)) -DialogResult ([System.Windows.Forms.DialogResult]::OK) -borderSize 2

    $patchExplorerPanel.controls.add($OKButton)

    $CancelButton = Create-ModernButton -Text 'Cancel' -Location (New-Object Drawing.Point(250, 350)) -Size (New-Object Drawing.Size(100, 27)) -DialogResult ([System.Windows.Forms.DialogResult]::Cancel) -borderSize 2
