...
function import-powerplan {
  ...
  if ($Autorun) {
    ...
    #dont display if plan is already imported
    if ("zoic's ultimate performance" -notin $powerplanNames) {
    ...
    $tabControl.Size = New-Object System.Drawing.Size(470, 200)
    $tabControl.BackColor = 'Black'
    $form.Controls.Add($tabControl)

    # Create Power Plan Tab
    $tabPowerPlan = New-Object System.Windows.Forms.TabPage
    $tabPowerPlan.Text = 'Power Plan'
    $tabPowerPlan.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $tabControl.Controls.Add($tabPowerPlan)

    # Create USB Power Tab
    $tabUSBPower = New-Object System.Windows.Forms.TabPage
    $tabUSBPower.Text = 'USB Power'
    $tabUSBPower.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $tabControl.Controls.Add($tabUSBPower)

    #usb power tree
    $treeView = New-Object System.Windows.Forms.TreeView
    $treeView.CheckBoxes = $true
    $treeView.Location = New-Object System.Drawing.Point(10, 23)
    $treeView.Size = New-Object System.Drawing.Point(440, 140)
    $treeView.Scrollable = $true
    $treeView.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $treeView.ForeColor = [System.Drawing.Color]::White 
    $tabUSBPower.Controls.Add($treeView)
    ...
    $controllers = $usbDevices | Where-Object { $_.Name -like '*Host Controller*' } |
    Group-Object -Property InstanceId -AsHashTable -AsString

    $genhubs = $usbDevices | Where-Object { $_.Name -like '*USB Hub*' } |
    ...
    foreach ($controller in $controllers.Values) {
      ...
      foreach ($device in $childDevices) {
        ...
        # If the device is a hub, process its child devices
        if ($genhubs.ContainsKey($device.InstanceId)) {
          ...
          # Add devices connected to this hub
          ...
          foreach ($hubChild in $hubChildren) {
            ...
            # Check if this device has any children
        ...
        # If the device is not a hub but has child devices
    ...
    # Power Plan Tab Content
    $labelPowerPlan = New-Object System.Windows.Forms.Label
    $labelPowerPlan.Text = 'Remove Power Plans:'
    $labelPowerPlan.Location = New-Object System.Drawing.Point(10, 10)
    $labelPowerPlan.Size = New-Object System.Drawing.Size(200, 20)
    $labelPowerPlan.Font = New-Object System.Drawing.Font($dmMonoFont, 10)
    $labelPowerPlan.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($labelPowerPlan)
    
    #usb power label
    $labelUSBPower = New-Object System.Windows.Forms.Label
    $labelUSBPower.Text = 'Disable Power Saving:'
    $labelUSBPower.Location = New-Object System.Drawing.Point(10, 5)
    $labelUSBPower.Size = New-Object System.Drawing.Size(200, 20)
    $labelUSBPower.Font = New-Object System.Drawing.Font($dmMonoFont, 10)
    $labelUSBPower.ForeColor = 'White'
    $tabUSBPower.Controls.Add($labelUSBPower)
    ...
    $checkboxRestore.Location = New-Object System.Drawing.Point(110, 135)
    $checkboxRestore.Size = New-Object System.Drawing.Size(125, 20)
    $checkboxRestore.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($checkboxRestore)
    ...
    $tabPowerPlan.Controls.Add($checkedListBox)

    $labelHidden = New-Object System.Windows.Forms.Label
    $labelHidden.Text = 'Enable Hidden Power Plans:'
    $labelHidden.Location = New-Object System.Drawing.Point(230, 10)
    $labelHidden.Size = New-Object System.Drawing.Size(250, 20)
    $labelHidden.Font = New-Object System.Drawing.Font($dmMonoFont, 10)
    $labelHidden.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($labelHidden)

    # Create the checkboxes for power plans
    $checkbox1 = New-Object System.Windows.Forms.CheckBox
    $checkbox1.Text = 'Ultimate Performance'
    $checkbox1.Location = New-Object System.Drawing.Point(230, 35)
    $checkbox1.Size = New-Object System.Drawing.Size(200, 20)
    $checkbox1.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($checkbox1)

    $checkbox2 = New-Object System.Windows.Forms.CheckBox
    $checkbox2.Text = 'Max Performance Overlay'
    $checkbox2.Location = New-Object System.Drawing.Point(230, 65)
    $checkbox2.Size = New-Object System.Drawing.Size(200, 20)
    $checkbox2.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($checkbox2)

    $checkbox3 = New-Object System.Windows.Forms.CheckBox
    $checkbox3.Text = 'High Performance Overlay'
    $checkbox3.Location = New-Object System.Drawing.Point(230, 95)
    $checkbox3.Size = New-Object System.Drawing.Size(200, 20)
    $checkbox3.ForeColor = 'White'
    $tabPowerPlan.Controls.Add($checkbox3)
    ...
    $CancelButton = New-Object System.Windows.Forms.Button
    $CancelButton.Location = New-Object System.Drawing.Point(240, 215)
...
function import-reg {
  ...
  if ($AutoRun) {
    ...
    $form3.Size = New-Object System.Drawing.Size(790, 650)
    ...
    $searchBox10.Location = New-Object System.Drawing.Point(10, 90)
    ...
    $searchBox11.Location = New-Object System.Drawing.Point(405, 90)
    $searchBox11.Size = New-Object System.Drawing.Size(150, 20)
    $form3.Controls.Add($searchBox11)


    $pictureBox = New-Object System.Windows.Forms.PictureBox
    $pictureBox.Location = New-Object System.Drawing.Point(165, 90) 
    ...
    $pictureBox2.Location = New-Object System.Drawing.Point(560, 90) 
    ...
    $label3 = New-Object System.Windows.Forms.Label
    $label3.Location = New-Object System.Drawing.Point(10, 65)
    ...
    $label4 = New-Object System.Windows.Forms.Label
    $label4.Location = New-Object System.Drawing.Point(405, 65)
    $label4.Size = New-Object System.Drawing.Size(150, 20)
    $label4.Text = 'Windows 11'
    $label4.ForeColor = 'White'
    $label4.Font = New-Object System.Drawing.Font($dmMonoFont, 10) 
    $form3.Controls.Add($label4)

    $checkedListBox10 = New-Object System.Windows.Forms.CheckedListBox
    $checkedListBox10.Location = New-Object System.Drawing.Point(10, 115)
    ...
    $checkedListBox11.Location = New-Object System.Drawing.Point(405, 115)
...
"@
    ...
    $default.Location = New-Object System.Drawing.Point(215, 555)
    $default.Size = New-Object System.Drawing.Size(160, 35)
    ...
    $custom.Location = New-Object System.Drawing.Point(385, 555)
    $custom.Size = New-Object System.Drawing.Size(160, 35)
...
function OptionalTweaks {
  ...
  if ($AutoRun) {
    ...
    $checkbox51.Checked = $opNoGUIBoot
  }
  else {
    ...
    $checkbox51.Location = new-object System.Drawing.Size(220, 340)
    ...
    $TabPage1.Controls.Add($checkBox51)

    $checkbox52.Location = new-object System.Drawing.Size(10, 380)
    ...
    $TabPage1.Controls.Add($checkBox52)
...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $form.Size = New-Object Drawing.Size(450, 430)
    $form.BackColor = 'Black'
    $form.Font = New-Object System.Drawing.Font($dmMonoFont, 8)
    $form.Icon = New-Object System.Drawing.Icon($Global:customIcon)

    # Info Button (optional, but kept from original script)
    ...
    $tabControl.Size = New-Object Drawing.Size(420, 350)
    $tabControl.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)

    # Patch Explorer Tab
    $tabPatchExplorer = New-Object System.Windows.Forms.TabPage
    $tabPatchExplorer.Text = 'Patch Explorer'
    $tabPatchExplorer.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)

    # Win 10 Tab
    $tabWin10 = New-Object System.Windows.Forms.TabPage
    $tabWin10.Text = 'Windows 10'
    $tabWin10.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)

    # Misc Tab
    $tabMisc = New-Object System.Windows.Forms.TabPage
    $tabMisc.Text = 'Misc'
    $tabMisc.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)

    # Patch Explorer Checkboxes
    
    $checkbox2.Location = New-Object System.Drawing.Point(20, 10)
    ...
    $checkbox2.Checked = $false
    $tabPatchExplorer.Controls.Add($checkbox2)

   
    $checkbox4.Location = New-Object System.Drawing.Point(20, 40)
    ...
    $checkbox4.ForeColor = 'White'
    $checkbox4.Checked = $false
    $tabPatchExplorer.Controls.Add($checkbox4)

   
    $checkbox6.Location = New-Object System.Drawing.Point(20, 70)
    ...
    $checkbox6.Checked = $false
    $tabPatchExplorer.Controls.Add($checkbox6)

   
    $checkbox8.Location = New-Object System.Drawing.Point(20, 100)
    ...
    $checkbox8.Checked = $false
    $tabPatchExplorer.Controls.Add($checkbox8)
    ...
    $checkbox7.ForeColor = 'White'
    $checkbox7.Checked = $false
    $tabPatchExplorer.Controls.Add($checkbox7)

    # Win 10 Checkboxes
   
    $checkbox9.Location = New-Object System.Drawing.Point(20, 10)
    ...
    $checkbox9.ForeColor = 'White'
    $checkbox9.Checked = $false
    $tabWin10.Controls.Add($checkbox9)

    
    $checkbox13.Location = New-Object System.Drawing.Point(20, 40)
    ...
    $checkbox13.ForeColor = 'White'
    $checkbox13.Checked = $false
    $tabWin10.Controls.Add($checkbox13)

    
    $checkbox15.Location = New-Object System.Drawing.Point(20, 70)
    ...
    $checkbox15.ForeColor = 'White'
    $checkbox15.Checked = $false
    $tabWin10.Controls.Add($checkbox15)

   
    $checkbox17.Location = New-Object System.Drawing.Point(20, 100)
    ...
    $checkbox17.ForeColor = 'White'
    $checkbox17.Checked = $false
    $tabWin10.Controls.Add($checkbox17)

   
    $checkbox19.Location = New-Object System.Drawing.Point(20, 130)
    ...
    $checkbox19.ForeColor = 'White'
    $checkbox19.Checked = $false
    $tabWin10.Controls.Add($checkbox19)

    # Misc Checkboxes
   
    $checkbox3.Location = New-Object System.Drawing.Point(20, 10)
    ...
    $checkbox3.Checked = $false
    $tabMisc.Controls.Add($checkbox3)

   
    $checkbox5.Location = New-Object System.Drawing.Point(20, 40)
    ...
    $checkbox5.Checked = $false
    $tabMisc.Controls.Add($checkbox5)

    
    $checkbox11.Location = New-Object System.Drawing.Point(20, 70)
    ...
    $tabMisc.Controls.Add($checkbox11)
    ...
    $tabMisc.Controls.Add($checkbox21)
    ...
    $checkbox22.Font = New-Object System.Drawing.Font($dmMonoFont, 9)
    $checkbox22.ForeColor = 'White'
    $checkbox22.Checked = $false
    $tabMisc.Controls.Add($checkbox22)

 
    $checkbox23.Location = New-Object System.Drawing.Point(20, 160)
    $checkbox23.Size = New-Object System.Drawing.Size(360, 30)
    $checkbox23.Text = 'Remove System Label From StartMenu Apps'
    $checkbox23.Font = New-Object System.Drawing.Font($dmMonoFont, 9)
    $checkbox23.ForeColor = 'White'
    $checkbox23.Checked = $false
    $tabMisc.Controls.Add($checkbox23)

    # Add Tabs to TabControl
    $tabControl.Controls.Add($tabPatchExplorer)
    $tabControl.Controls.Add($tabWin10)
    ...
    $OKButton = New-Object System.Windows.Forms.Button
    $OKButton.Location = New-Object System.Drawing.Point(112, 365)
    ...
    $CancelButton = New-Object System.Windows.Forms.Button
    $CancelButton.Location = New-Object System.Drawing.Point(210, 365)
...
function UltimateCleanup {
  ...
  $buttonClean.Location = New-Object System.Drawing.Point(270, 200)
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    if ($checkBox5.Checked) {
      ...
      Remove-Item "$env:SystemDrive\Windows.old" -Force -ErrorAction SilentlyContinue
    }
