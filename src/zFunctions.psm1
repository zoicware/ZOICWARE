function debloat {
  ...
  if ($AutoRun) {
    ...
    $checkAll.Location = New-Object System.Drawing.Point(468, 28)
...
'@
      ...
      $filePath = Search-File '*nodefender.zip'
      ...
      Start-Process "$folder\nodefender\ilovedefender.exe" -ArgumentList '--av' -WindowStyle Hidden
...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $form.Size = New-Object Drawing.Size(450, 530)
    $form.BackColor = 'Black'
    $form.Font = New-Object System.Drawing.Font($dmMonoFont, 8)
    ...
    $OKButton = New-Object System.Windows.Forms.Button
    $OKButton.Location = New-Object System.Drawing.Point(112, 450)
    $OKButton.Size = New-Object System.Drawing.Size(100, 23)
    $OKButton.Text = 'OK'
    $OKButton.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $OKButton.ForeColor = [System.Drawing.Color]::White
    ...
    $CancelButton = New-Object System.Windows.Forms.Button
    $CancelButton.Location = New-Object System.Drawing.Point(210, 450)
    $CancelButton.Size = New-Object System.Drawing.Size(100, 23)
    $CancelButton.Text = 'Cancel'
    $CancelButton.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $CancelButton.ForeColor = [System.Drawing.Color]::White
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    if ($checkbox6.Checked) {
      ...
      Custom-MsgBox -message 'Import Explorer Patcher Config From Desktop' -type None
...
function Custom-MsgBox {
  ...
  $okButton.BackColor = [System.Drawing.Color]::FromArgb(43, 43, 42)
  $okButton.ForeColor = [System.Drawing.Color]::White
  $oKButton.DialogResult = [System.Windows.Forms.DialogResult]::OK
  $form.Controls.Add($okButton)
  ...
  if (!($type -eq 'None')) {
    ...
    $cancelButton.BackColor = [System.Drawing.Color]::FromArgb(43, 43, 42)
    $cancelButton.ForeColor = [System.Drawing.Color]::White
    $cancelButton.DialogResult = [System.Windows.Forms.DialogResult]::Cancel
    $form.Controls.Add($cancelButton)
