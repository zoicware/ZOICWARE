...
function OptionalTweaks {
  ...
  if ($AutoRun) {
    ...
    $checkbox6.Size = new-object System.Drawing.Size(160, 20)
    ...
    $checkbox25.Size = new-object System.Drawing.Size(170, 20)
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    if ($checkbox2.Checked) {
      Write-Host 'Applying Black Theme...'
      ...
      if ($classicblackBTN.Checked) {
        Write-Host 'Applying Classic Theme...'
    ...
    if ($checkbox5.Checked) {
      Write-Host 'Removing Speech App...'
    ...
    if ($checkbox8.checked) {
      Write-Host 'Applying Transparent Taskbar...'
    ...
    if ($checkbox9.Checked) {
      Write-Host 'Removing Quick Access...'
    ...
    if ($checkbox13.Checked) {
      Write-Host 'Blocking Razer and ASUS Downloads via Hosts File...'
    ...
    if ($checkbox23.Checked) {
      Write-Host 'Removing Network Icon From File Explorer...'
    ...
    if ($checkbox27.Checked) {
      Write-Host 'Enabling Double Click to Run PowerShell Scripts...'
      #working 10 not 11
    ...
    if ($checkbox29.Checked) {
      Write-Host 'Excluding Drivers From Windows Update...'
    ...
    if ($checkbox31.Checked) {
      Write-Host 'Removing Mouse and Sound Schemes...'
...
"@
    ...
    if ($checkbox33.Checked) {
      Write-Host 'Removing Recycle Bin Icon Text...'
    ...
    if ($checkbox47.Checked) {
      Write-Host 'Pausing Updates for 1 Year...'
      #pause for 1 year
...
function W11Tweaks {
  ...
  if ($Autorun) {
    ...
    $form.Size = New-Object Drawing.Size(450, 580)
    $form.BackColor = 'Black'
    $form.Font = New-Object System.Drawing.Font($dmMonoFont, 8)
    ...
    $checkbox3.Location = new-object System.Drawing.Size(20, 200)
    ...
    $checkbox5.Location = new-object System.Drawing.Size(20, 230)
    ...
    $checkbox7.Location = new-object System.Drawing.Size(20, 260)
    ...
    $checkbox9.Location = new-object System.Drawing.Size(20, 290)
    ...
    $checkbox11.Location = new-object System.Drawing.Size(20, 320)
    ...
    $checkbox13.Location = new-object System.Drawing.Size(20, 350)
    ...
    $checkbox15.Location = new-object System.Drawing.Size(20, 380)
    ...
    $checkbox17.Location = new-object System.Drawing.Size(20, 410)
    ...
    $checkbox19.Location = new-object System.Drawing.Size(20, 440)
    ...
    $checkbox21.Location = new-object System.Drawing.Size(20, 470)
    ...
    $OKButton = New-Object System.Windows.Forms.Button
    $OKButton.Location = New-Object System.Drawing.Point(112, 510)
    $OKButton.Size = New-Object System.Drawing.Size(100, 23)
    $OKButton.Text = 'OK'
    $OKButton.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $OKButton.ForeColor = [System.Drawing.Color]::White
    ...
    $CancelButton = New-Object System.Windows.Forms.Button
    $CancelButton.Location = New-Object System.Drawing.Point(210, 510)
    $CancelButton.Size = New-Object System.Drawing.Size(100, 23)
    $CancelButton.Text = 'Cancel'
    $CancelButton.BackColor = [System.Drawing.Color]::FromArgb(30, 30, 30)
    $CancelButton.ForeColor = [System.Drawing.Color]::White
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    if ($checkbox4.Checked) {
      if (!(Test-Path -Path "$systemDrive\Program Files\ExplorerPatcher\ep_setup.exe" -ErrorAction SilentlyContinue)) {
        ...
        try {
          ...
          Write-Host 'This tweak requires Internet Connection' -ForegroundColor Red
        }
        #disable notis
    ...
    if ($checkbox6.Checked) {
      Write-Host 'Enabling Windows 10 File Explorer Ribbon...'  
...
'@
    ...
    if ($checkbox15.Checked) {
      Write-Host 'Replacing Windows 11 Taskmanager with Windows 10...'
    ...
    if ($checkbox17.Checked) {
      ...
      Write-Host 'Uninstalling UWP Notepad'
      try {
      ...
      Write-Host 'Installing Windows 11 21h2 Notepad'
    ...
    if ($checkbox8.Checked) {
      ...
      Write-Host 'Hiding Startmenu Recommended Section...'
      & $hiderec 
...
"@
    ...
    if ($checkbox19.Checked) {
      ...
      Write-Host 'Making Backup of C:\Windows\SystemResources\imageres.dll.mun > Desktop'
      ...
      Write-Host 'Replacing With Windows 10 Icons...'
    ...
    if ($checkbox21.Checked) {
      Write-Host 'Backing up Original Winver.exe > Desktop'
      takeown.exe /f 'C:\Windows\System32\winver.exe' *>$null
      icacls.exe 'C:\Windows\System32\winver.exe' /grant Administrators:F /T /C *>$null
      Copy-item 'C:\Windows\System32\winver.exe' -Destination "$env:USERPROFILE\Desktop" -Force
      Rename-Item "$env:USERPROFILE\Desktop\winver.exe" -NewName 'OGwinver.exe' -Force
      $Menu = $true
      do {
        $input = Read-Host "Choose 1 For Standard `nChoose 2 for Mono Theme" 
        if ($input -eq 1) {
          Write-Host 'Replacing Winver...'
