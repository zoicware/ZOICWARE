...
function debloat {
  ...
  function debloat-TeamsOneDrive {
    ...
    if ($OneDrivePath) {
      robocopy "$OneDrivePath" "$($env:USERPROFILE.TrimEnd())" /mov /e /xj *>$null
    }
...
'@ 
  ...
  if ($AutoRun) {
    ...
    $applyPreset = Create-ModernButton -Text 'Apply Preset' -Location (New-Object Drawing.Point(20, 150)) -Size (New-Object Drawing.Size(480, 30)) -DialogResult ([System.Windows.Forms.DialogResult]::OK) -ClickAction {
...
function OptionalTweaks {
  ...
  $settings['opNoMouseAccel'] = $checkbox60
  ...
  if ($AutoRun) {
    ...
    $checkbox9.Location = New-Object System.Drawing.Size(10, 70)
    $checkbox9.Size = New-Object System.Drawing.Size(240, 30)
    $checkbox9.Text = 'Remove Quick Access From File Explorer'
    $checkbox9.ForeColor = 'White'
    $checkbox9.Checked = $false
    $visualGroupBox.Controls.Add($checkbox9)
    
    $checkbox23.Location = New-Object System.Drawing.Size(10, 95)
    ...
    $checkbox33.Location = New-Object System.Drawing.Size(10, 120)
    ...
    $checkbox31.Location = New-Object System.Drawing.Size(10, 145)
    ...
    $checkbox57.Location = New-Object System.Drawing.Size(10, 170)
    ...
    $checkbox59.Location = New-Object System.Drawing.Size(10, 195)
    ...
    $checkbox60.Location = New-Object System.Drawing.Size(10, 220)
    ...
    $checkbox7.Location = New-Object System.Drawing.Size(10, 45)
    $checkbox7.Size = New-Object System.Drawing.Size(200, 30)
    $checkbox7.Text = 'Enable HAGS'
    $checkbox7.ForeColor = 'White'
    $checkbox7.Checked = $false
    $miscGroupBox.Controls.Add($checkbox7)
    
    $checkbox13.Location = New-Object System.Drawing.Size(10, 70)
    ...
    $checkbox24.Location = New-Object System.Drawing.Size(10, 95)
    ...
    $checkbox51.Location = New-Object System.Drawing.Size(10, 120)
    ...
    $checkbox52.Location = New-Object System.Drawing.Size(10, 145)
    ...
    $checkbox56.Location = New-Object System.Drawing.Size(270, 70)
    $checkbox56.Size = New-Object System.Drawing.Size(240, 30)
    $checkbox56.Text = 'Remove Backup App'
    $checkbox56.ForeColor = 'White'
    $checkbox56.Checked = $false
    $miscGroupBox.Controls.Add($checkbox56)
    
    $checkbox58.Location = New-Object System.Drawing.Size(270, 95)
    ...
    $checkbox32.Location = New-Object System.Drawing.Size(270, 120)
    $checkbox32.Size = New-Object System.Drawing.Size(240, 30)
    $checkbox32.Text = 'Enable Windows 11 Sounds on Windows 10'
    $checkbox32.ForeColor = 'White'
    $checkbox32.Checked = $false
    $miscGroupBox.Controls.Add($checkbox32)

    $checkbox61.Location = New-Object System.Drawing.Size(270, 145)
  ...
  if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    if ($checkbox56.Checked) {
      ...
      $choice = Read-Host 'Are you sure you want to remove backup app? [Y/N]'
...
function W11Tweaks {
  param (
    ...
    , [Parameter(mandatory = $false)] [bool]$disableResume = $false
  ...
  $settings['disableResume'] = $checkbox27
  ...
  if ($Autorun) {
    ...
    $checkbox27.Checked = $disableResume
    ...
    $checkbox27.Location = New-Object System.Drawing.Point(20, 310)
    $checkbox27.Size = New-Object System.Drawing.Size(360, 30)
    $checkbox27.Text = 'Disable Resume'
    $checkbox27.Font = New-Object System.Drawing.Font('Segoe UI', 9)
    $checkbox27.ForeColor = 'White'
    $checkbox27.Checked = $false
    $miscPanel.Controls.Add($checkbox27)

    $checkbox28.Location = New-Object System.Drawing.Point(20, 340)
    ...
    $checkbox29.Location = New-Object System.Drawing.Point(20, 370)
    ...
    $checkbox30.Location = New-Object System.Drawing.Point(20, 400)
...
'@
    ...
    if ($checkbox27.Checked) {
      Write-Status -Message 'Disabling Cross Device Resume from Running...' -Type Output
      #create task to kill resume on any user logon
      <#
      $taskName = 'Kill Resume'
      $principal = New-ScheduledTaskPrincipal -UserId 'SYSTEM' -LogonType ServiceAccount -RunLevel Highest
      $action = New-ScheduledTaskAction -Execute 'taskkill' -Argument '/im CrossDeviceResume.exe /f'
      $trigger = New-ScheduledTaskTrigger -AtLogOn
      $settings = New-ScheduledTaskSettingsSet -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries -StartWhenAvailable
      Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Force | Out-Null
      #>
      #use the debugger exploit to run systray.exe instead of cross device resume
      Reg.exe add 'HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\CrossDeviceResume.exe' /v 'Debugger' /t REG_SZ /d 'systray.exe' /f *>$null
      #disable resume (only disables the functionality not the process running)
      ...
      #disable resume with csp policy 
      ...
      #disable resume with velocity id
      ...
      #disable webview from running under search host (unnecessary dependency nice one ms -_-)
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\8\1694661260' /v 'EnabledState' /t REG_DWORD /d '1' /f *>$null
      #remove resume update 
      Reg.exe delete 'HKLM\SOFTWARE\Microsoft\WindowsUpdate\Orchestrator\UScheduler_Oobe\CrossDeviceUpdate' /f *>$null
      #disable resume policy in region policy json file
      ...
      if (Test-Path $JSONPath) {
        ...
        $policy = $jsonContent.policies | Where-Object { $_.guid -like '*e2961891-e5ef-436a-b009-7801281c3fbf*' }
    ...
    if ($checkbox30.Checked) {
      ...
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\3036241548' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      ...
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\2792562829' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      ...
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\762256525' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      ...
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\734731404' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\2114784909' /v 'EnabledState' /t REG_DWORD /d '2' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\2114784909' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\905601679' /v 'EnabledState' /t REG_DWORD /d '2' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\905601679' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\1853569164' /v 'EnabledState' /t REG_DWORD /d '2' /f >$null
      Reg.exe add 'HKLM\SYSTEM\ControlSet001\Control\FeatureManagement\Overrides\14\1853569164' /v 'EnabledStateOptions' /t REG_DWORD /d '0' /f >$null
    }
